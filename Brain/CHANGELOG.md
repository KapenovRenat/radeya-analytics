...
- Добавлена задача от Дамира на 2026-06-09: в разделе «Отмены и возвраты» показывать товары, отменённые клиентом уже после выдачи в отгрузку («отменены в пути») — с суммой и количеством
- Обновлено index.md — добавлена ссылка на [[backlog]]
